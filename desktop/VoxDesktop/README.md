...
- Computer Use tasks may run for up to ten minutes; each individual tool call still stops if it stalls for a minute. Vox keeps the conversation going and reports the result when it finishes.
