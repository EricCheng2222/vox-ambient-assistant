...
- **Choosing places:** in **Reminders → Places on this iPhone**, use **Choose on map** to search for an address or pan a pin into position. The circle shows the area that triggers the reminder. You can also save your current location, tap a saved place to move it, or tap **Choose “…” on the map** on a reminder whose place wasn’t found. Personal places such as 家, 公司, 奶奶家, or “mom’s house” are never matched by searching; they must be saved or picked on the map.
